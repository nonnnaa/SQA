...
class DonHangServiceImplTest {
    ...
    /**
     * TC01 - Mục tiêu: Lấy đơn hàng theo ID thành công
     * Input: id = 1
    ...
    /**
     * TC02 - Mục tiêu: Lấy đơn hàng không tồn tại
     * Input: id = 99
    ...
    /**
     * TC03 - Mục tiêu: Xóa đơn hàng theo ID
     * Input: id = 3
    ...
    /**
     * TC04 - Mục tiêu: Tạo đơn hàng nhưng thiếu người tạo (cả KhachHangId và NguoiDungId đều null)
    ...
    /**
     * TC05 - Mục tiêu: Thay đổi trạng thái thanh toán thành công
    ...
    /**
     * TC06 - Mục tiêu: Thay đổi trạng thái thanh toán nhưng đơn hàng không tồn tại
    ...
    /**
     * TC07 - Mục tiêu: Cập nhật tồn kho khi giao hàng thành công
    ...
    /**
     * TC08 - Mục tiêu: Tạo đơn hàng hợp lệ với NguoiDung và chi tiết đơn hàng
    ...
    /**
     * TC09 - Mục tiêu: Cập nhật đơn hàng nhưng không tồn tại trong DB
    ...
    /**
     * TC10 - Mục tiêu: Cập nhật đơn hàng nhưng thiếu thông tin người tạo
    ...
    /**
     * TC11 - Mục tiêu: Lấy danh sách đơn hàng khi không có keyword và id = 0
    ...
    /**
     * TC12 - Mục tiêu: Lấy danh sách đơn hàng theo ID người dùng
    ...
    /**
     * TC13 - Mục tiêu: Lấy danh sách đơn hàng theo trạng thái giao hàng cụ thể
    ...
    /**
     * TC14 - Mục tiêu: Đổi trạng thái giao hàng nhưng đơn hàng không tồn tại
    ...
    /**
     * TC15 - Mục tiêu: Đổi trạng thái giao hàng thành DA_HUY và tạo thông báo
    ...
    /**
     * TC16 - Mục tiêu: Gọi create với phương thức thanh toán không hợp lệ
    ...
    /**
     * TC17 - Mục tiêu: Tạo đơn hàng với KhachHang và kiểm tra tạo thông báo thành công
    ...
    /**
     * TC18 - Mục tiêu: Đổi trạng thái giao hàng thành DA_GIAO sẽ gọi updateSoLuongKho
    ...
    /**
     * TC19 - Mục tiêu: getByTrangThaiGiaoHang có sortedField hợp lệ
